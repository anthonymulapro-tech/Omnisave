                ...
                >
                    ...
                    <SwiperSlide className="onboarding-slide">
                        <div className="slide-content">
                            ...
                            <p>
                                Activer le fast-save sur votre profil pour enregistrer rapidement et éditer plus tard.
                            </p>
                            <div className="media-placeholder">
                    ...
                    {/* SLIDE 3: PC - Manual Link Addition */}
                    <SwiperSlide className="onboarding-slide">
                        <div className="slide-content">
                    ...
                    {/* SLIDE 4: PC - Extension & Fast Save */}
                    <SwiperSlide className="onboarding-slide">
                        <div className="slide-content">
                            ...
                            <div className="media-placeholder">
                                <video src="/videos/onboarding-slide-4.mp4" autoPlay loop muted playsInline className="guide-video" />
                            </div>
                        </div>
                    </SwiperSlide>

                    {/* SLIDE 5: Mobile - PWA Installation & Shortcut Setup */}
                    <SwiperSlide className="onboarding-slide">
                        <div className="slide-content">
                            ...
                            <div className="media-placeholder">
                                <video src="/videos/onboarding-slide-5.mp4" autoPlay loop muted playsInline className="guide-video" />
                            </div>
                        </div>
                    </SwiperSlide>
                    ...
                    {/* SLIDE 6: Conclusion & Call to action */}
                        <SwiperSlide className="onboarding-slide">
                            <div className="slide-content">
                                ...
                                <p>
                                    Vous pouvez retrouver ce guide à tout moment dans l'onglet <strong>"Guide d'utilisation"</strong>.
                                    <br/><br/>
                                    Sauvegarder tous vos contenus sur une même plateforme n'a jamais été aussi rapide, les retrouver encore PLUS !
                                </p>

                                <div className="media-placeholder">
                                    <video src="/videos/onboarding-slide-6.mp4" autoPlay loop muted playsInline className="guide-video" />
                                </div>

                                <button className="btn-primary mt-3 mb-2" onClick={onClose}>
